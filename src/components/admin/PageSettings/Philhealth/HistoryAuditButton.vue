...
<template>
  <q-btn
    icon="mdi-history"
    label="History"
    @click="philhealthHistoryButtonStore.triggerPrompt"
  />
  <q-dialog v-model="philhealthHistoryButtonStore.viewPrompt" persistent>
    <div class="!tw-h-min !tw-w-9/12 !tw-max-w-full tw-bg-white tw-p-6">
      <q-table
        ...
        separator="cell"
        row-key="audit_id"
        :rows="philhealthHistoryButtonStore.historyDataRows"
        :columns="philhealthHistoryButtonStore.historyDataColumns"
      >
      </q-table>
